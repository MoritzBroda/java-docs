...
classDiagram
  ...
  CablePhone --> Phone : extends
  SmartPhone --> Phone : extends
...
Hinweis: Die maximale Energie beträgt 1000!
...
erzeugte Telefone in einer ArrayList. Ermittle mithilfe einer Schleife die
